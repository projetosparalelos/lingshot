...
class LanguageChoiceRepositoryImpl @Inject constructor(
    ...
    override fun getLanguage(translateLanguageType: TranslateLanguageType): Flow<AvailableLanguage?> {
        return languageChoiceLocalStorage.getLanguage(translateLanguageType)
    }

    override suspend fun saveLanguage(availableLanguage: AvailableLanguage?, translateLanguageType: TranslateLanguageType?) {
        languageChoiceLocalStorage.saveLanguage(availableLanguage, translateLanguageType)
    }
}
