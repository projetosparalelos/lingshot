...
enum class AvailableLanguage(
    ...
    CHINESE(displayName = R.string.text_display_name_chinese_language, languageCode = "zh", flagEmoji = "\uD83C\uDDE8\uD83C\uDDF3", enabledDictionary = false),
    ...
    JAPANESE(displayName = R.string.text_display_name_japanese_language, languageCode = "ja", flagEmoji = "\uD83C\uDDEF\uD83C\uDDF5", enabledDictionary = false),
    KOREAN(displayName = R.string.text_display_name_korean_language, languageCode = "ko", flagEmoji = "\uD83C\uDDF0\uD83C\uDDF7", enabledDictionary = false),
