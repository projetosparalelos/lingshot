...
val dark_completed_pieChart = Color(0xFF90CAF9)

val light_answerSuccess = Color(0xFF296C00)
val light_onAnswerSuccess = Color(0xFFFFFFFF)
val light_answerSuccessContainer = Color(0xFF84FE46)
val light_onAnswerSuccessContainer = Color(0xFF072100)

val dark_answerSuccess = Color(0xFF68E127)
val dark_onAnswerSuccess = Color(0xFF123800)
val dark_answerSuccessContainer = Color(0xFF1C1B1E)
val dark_onAnswerSuccessContainer = Color(0xFF84FE46)

val light_answerError = Color(0xFFBA1A1A)
val light_onAnswerError = Color(0xFFFFFFFF)
val light_answerErrorContainer = Color(0xFFFFDAD5)
val light_onAnswerErrorContainer = Color(0xFF410002)

val dark_answerError = Color(0xFFFFB4AB)
