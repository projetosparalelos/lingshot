package com.teachmeprint.language.core.common.helper
...
class NotificationClearScreenshot @Inject constructor(private val context: Context) {
    ...
    fun start() {
        ...
        if (numScreenShotsTaken == NUM_SCREENSHOTS_TAKEN_MAX) {
            val notification =
                NotificationCompat.Builder(context, TeachMePrintApplication.CHANNEL_ID)
